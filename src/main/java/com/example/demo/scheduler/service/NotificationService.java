...
public class NotificationService implements INotificationService {
	...
	@Autowired
	private IFilesUpdated fileSystemUpdated;
	...
	public void notifyUsers() {		
		...
		sendMail = getFileSystemUpdated().isNewFileAdded(new Date());
	...
	public IFilesUpdated getFileSystemUpdated() {
		return fileSystemUpdated;
	}

	public void setFileSystemUpdated(IFilesUpdated fileSystemUpdated) {
		this.fileSystemUpdated = fileSystemUpdated;
	}
